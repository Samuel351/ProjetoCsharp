...
namespace ProjetoASPNetCore.Controllers
{
    public class DepartamentsController : Controller
    {
        ...
        public DepartamentsController(ProjetoASPNetCoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Departament != null ? 
                          ...
                          Problem("Entity set 'ProjetoASPNetCoreContext.Departament'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProjetoASPNetCoreContext.Departament'  is null.");
            }
            var departament = await _context.Departament.FindAsync(id);
            if (departament != null)
            {
